 ...
 * @version 0.9
 */
public class KundenvertreterAdapter extends CursorAdapter {
    private mainKundevertreter main;
    private LayoutInflater inflater;

    /**
     * Erstellt den Adapter für Kundenvertreter
     */
    public KundenvertreterAdapter(mainKundevertreter context, Cursor c, boolean autoRequery) {
